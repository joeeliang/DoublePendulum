...
def animate(t1, t2):
    ...
    while True:
        ...
        t += delta_t
        # if round(t, 2) in screenshotTimes:
        #     filename = os.path.join(screenshot_directory, f'periodicDouble.png')
        #     pygame.image.save(screen.subsurface(pygame.Rect((0, 0), (w, h))), filename)
        #     print("screeny!")
